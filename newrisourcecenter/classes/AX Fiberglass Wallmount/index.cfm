...
<!--TITLE: C:\Users\us00773\Documents\My Titles\AX Fiberglass Wallmount -->
...
<script>
VarTrivSelCap = new Variable( 'VarTrivSelCap', 'none', 0, 0, null, null, 'ax_fiberglass_wallmount', true );
var pagePlayer = null;
...
var bAutoStartOnFirstPage = false;
if(window.jQuery) triv$ = window.jQuery.noConflict(true);
var firstPageName = jumpToPage ? jumpToPage : 'title.html';
function onLoad(){
	 pagePlayer = new jsPagePlayer();
	 function cont(){
		 pagePlayer.gotoPage(firstPageName, true);
	 } 
	 window.bAutoStartOnPage = bAutoStartOnFirstPage;
	 enableAutoStart ( cont , t); 
}
</script>
</head>
